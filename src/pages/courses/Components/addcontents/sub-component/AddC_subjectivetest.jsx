...
const AddC_subjectivetest = ({  onClick }) => {
    const [subjectivetest, setsubjectivetest] = useState("")
            ...
            <div className="bg-white w-[250px] sm:w-[400px] h-full rounded-lg shadow-lg p-5 relative">
                ...
                <div className="mt-4">
                    ...
                    <input
                        ...
                        onChange={(e) => setsubjectivetest(e.target.value)}
                ...
                <div className="flex justify-end  mt-6 ">
                    <button
                        className={`px-4 py-2 rounded-md text-white font-medium ${subjectivetest.trim()
                                ? "bg-blue-500 hover:bg-blue-600"
                                : "bg-blue-300 cursor-not-allowed"
                            }`}
                        disabled={!subjectivetest.trim()}
                        onClick={() => {
...
export default AddC_subjectivetest;
